...
class TensorboardLogger:
    def __init__(self, log_dir: Optional[str]=None, enabled: bool=False) -> None:
        """
        Log metrics into a directory for visualization within the TensorBoard.
        :param log_dir: str, Path to a folder to save logs.
        :param enabled: bool, Enable Tensorboard or not.
        """
        self.writer = None
